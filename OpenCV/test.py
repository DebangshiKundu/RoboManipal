...
cap = cv2.VideoCapture('/Users/debangshi/Downloads/Scr.mp4')

# Create the color Finder object
myColorFinder = ColorFinder(True)
hsvVals = {'hmin': 10, 'smin': 100, 'vmin': 0, 'hmax': 100, 'smax': 255, 'vmax': 255}

# Variables
posListX, posListY = [], []
xList = [item for item in range(0, 900)] # image shpae of x -> 1300x1080
prediction = False
